...
const getAllStudnetFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield student_model_1.StudentModel.find();
    return result;
});
const getSingleStudnentFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
